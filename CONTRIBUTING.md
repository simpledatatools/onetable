...
## Choosing and using libraries

If you would like to use a library as part of the codebase you contribute, please make sure the library is approved beforehand by @locAtLaheriyam. In general, we only use libraries that are MIT licensed and well supported.
